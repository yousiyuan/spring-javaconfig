...
<script type="text/javascript" src="${root}/static/json3.min.js"></script>
<script type="text/javascript" src="${root}/static/jquery-1.10.2.js"></script>
<script type="text/javascript" language="javascript">
	...
	$(document).ready(function() {
		$("#btnAjaxRequestTest").click(function() {
			ajaxPostJsonRequest("${root}/webapi/brand1", {
				"cid" : "3029"
		...
		$("#btnAjaxRequestKVTest").click(function() {
			ajaxPostKeyValueRequest("${root}/webapi/brand", {
				"cid" : "3025"
			}, function(result, status, xhr) {
				$("#result").text(JSON.stringify(result));
			});
		...
		$("#btnUpdateTest").click(function () {
			ajaxPostJsonRequest("${root}/webapi/updateBrand", {
				"brandId": "3025",
				"brandName": "杰克琼斯" + Math.random(),
				"brandDesc": "名牌" + Math.random()
			}, function (result, status, xhr) {
				$("#result").text(JSON.stringify(result));
			});
		});
...
<body>
	...
	<input type="button" id="btnUpdateTest" value="更新数据 - 测试事务" />
	<div id="result"></div>
</body>
</html>